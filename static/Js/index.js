                                              ...
                                              <div class="media-content">
                                                  ...
                                                  <nav class="level is-mobile">
                                                      <div class="level-left">
                                                          <a class="level-item is-sparta" id="${post["_id"]}" aria-label="heart" onclick="toggle_like('${post["_id"]}', 'heart')">
                                                          ...
                                                          <a class="level-item is-sparta" id="${post["_id"]}" aria-label="star" onclick="toggle_star('${
                                                            post["_id"]
                                                          }', 'star')">
                                                          ...
                                                          <a class="level-item is-sparta" id="${post["_id"]}" aria-label="thumbsup" onclick="toggle_thumbsup('${
                                                            post["_id"]
                                                          }', 'thumbsup')">
...
function toggle_like(post_id, type) {
  ...
  let $a_like = $(`a[id='${post_id}'][aria-label='heart']`);
  // let $a_like = $(`#${post_id}`).filter('a[aria-label="heart"]');
...
function toggle_star(post_id, type) {
  console.log(post_id, type);
  let $a_like = $(`a[id='${post_id}'][aria-label='star']`);
...
function toggle_thumbsup(post_id, type) {
  console.log(post_id, type);
  let $a_like = $(`a[id='${post_id}'][aria-label='thumbsup']`);
